            ...
            <div class="container-fluid pb-5">
                <div class="row justify-content-md-center">
                    <div class="card-wrapper col-12 col-md-4 mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Se connecter Admin</h4>

                                <form action="/login/admin" method="POST">

                                    @csrf
                                    @if (Session('error'))
                                        <div class="alert alert-success">Email ou mot de passe invalide</div>
                                    @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="mdp" value="mdp">
                                    </div>
